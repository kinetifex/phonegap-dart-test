...
["app_router", "package:hybrid_dart_test/router.dart", , V, {
  "^": "",
  showAbout: [function(e) {
    J.set$display$x(document.querySelector("#home").style, "none");
    J.set$display$x(document.querySelector("#about").style, "");
  }, "call$1", "showAbout$closure", 2, 0, 12, 2],
  showHome: [function(e) {
    J.set$display$x(document.querySelector("#home").style, "");
    J.set$display$x(document.querySelector("#about").style, "none");
  }, "call$1", "showHome$closure", 2, 0, 12, 2]
}],
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 13],
  ...
  Future_wait_handleError: {
    "^": "Closure:35;box_0,eagerError_1,result_2",
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 53, 19, 20],
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:57;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, null, 31],
...
["", "package:hybrid_dart_test/device_init.dart", , S, {
  "^": "",
  initDevice: function() {
    var initOutput, t1, t2, onError, result;
    initOutput = document.querySelector("#inialize-output");
    initOutput.textContent = "initializing";
    t1 = $.device;
    if (t1 == null)
    ...
    t1.then$1(new S.initDevice_closure(initOutput));
    onError = new S.initDevice_closure0(initOutput);
    result = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
    t2 = result._zone;
    if (t2 !== C.C__RootZone)
  ...
  initDevice_closure: {
    "^": "Closure:37;initOutput_0",
    call$1: [function(device) {
      var parentElement;
      this.initOutput_0.textContent = "success";
      parentElement = document.querySelector("#deviceready-dart");
  ...
  initDevice_closure0: {
    "^": "Closure:37;initOutput_1",
    call$1: [function(e) {
      this.initOutput_1.textContent = "error";
      P.print(H.S(e));
...
["link_handler", "package:route_hierarchical/click_handler.dart", , V, {
  ...
  DefaultWindowClickHandler: {
    "^": "Object:61;_linkMatcher,_router,_normalizer,_link_handler$_window,_link_handler$_useFragment",
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    t1 = $.get$router();
    t2 = t1.root;
    t2.addRoute$3$enter$name$path(V.showAbout$closure(), "about", "/about");
    t2.addRoute$4$defaultRoute$enter$name$path(true, V.showHome$closure(), "home", "/");
    t1.listen$0();
  }, "call$0", "main$closure", 0, 0, 14]
},
1],
["nav_menu", "package:hybrid_dart_test/nav_menu.dart", , L, {
  "^": "",
  initNavMenu: function() {
    var navdrawerContainer, appbarElement, menuBtn, main, t1, t2, t3;
    ...
    t2 = new L.initNavMenu_toggleMenu(navdrawerContainer, appbarElement);
    t3 = J.get$onClick$x(main);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(t1), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(main, "touchstart", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(t1), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = J.get$onClick$x(menuBtn);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(t2), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(menuBtn, "touchstart", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(t2), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = J.get$onClick$x(navdrawerContainer);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(new L.initNavMenu_closure(t1)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(navdrawerContainer, "touchstart", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(new L.initNavMenu_closure0(t1)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = document.body;
    t3.toString;
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t3, "touchstart", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(new L.initNavMenu_closure1()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
  },
  initNavMenu_closeMenu: {
    "^": "Closure:63;navdrawerContainer_0,appbarElement_1",
    call$1: [function(evt) {
      var t1;
      if (!$._menuOpen)
        return;
  ...
  initNavMenu_toggleMenu: {
    "^": "Closure:63;navdrawerContainer_2,appbarElement_3",
    call$1: [function(evt) {
      var t1, t2;
      if ($._menuOpen)
        return;
  ...
  initNavMenu_closure0: {
    "^": "Closure:37;closeMenu_5",
    call$1: [function($event) {
      var t1, href;
      t1 = J.getInterceptor$x($event);
      if (J.get$nodeName$x(t1.get$target($event)) === "A" || J.get$nodeName$x(t1.get$target($event)) === "LI")
        this.closeMenu_5.call$1($event);
      if (!!J.getInterceptor(t1.get$target($event)).$isAnchorElement) {
        href = H.interceptedTypeCast(t1.get$target($event), "$isAnchorElement").getAttribute("href");
        $.get$router().gotoUrl$1(href);
      }
    }, "call$1", null, 2, 0, null, 64, "call"]
  },
  initNavMenu_closure1: {
    "^": "Closure:37;",
    call$1: [function(evt) {
      var t1 = J.getInterceptor$x(evt);
      if (!!J.getInterceptor(t1.get$target(evt)).$isInputElement || !!J.getInterceptor(t1.get$target(evt)).$isTextAreaElement)
        H.interceptedTypeCast(t1.get$target(evt), "$isHtmlElement").focus();
      t1.stopPropagation$0(evt);
      t1.preventDefault$0(evt);
    }, "call$1", null, 2, 0, null, 62, "call"]
  }
}],
["reverser", "package:hybrid_dart_test/reverser.dart", , L, {
  "^": "",
  initReverser: function() {
    var output, input, t1;
    output = document.querySelector("#out");
    input = document.querySelector("#name");
    t1 = J.get$onKeyUp$x(input);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new L.initReverser_closure(output, input)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  initReverser_closure: {
    "^": "Closure:37;output_0,input_1",
    call$1: [function(_) {
      var t1 = J.split$1$s(J.get$value$x(this.input_1), "");
      this.output_0.textContent = H.setRuntimeTypeInfo(new H.ReversedListIterable(t1), [H.getTypeArgumentByIndex(H.setRuntimeTypeInfo(new H.IterableMixinWorkaround(), [H.getTypeArgumentByIndex(t1, 0)]), 0)]).join$0(0);
    }, "call$1", null, 2, 0, null, 41, "call"]
  }
}],
["rikulo_device", "package:rikulo_gap/device.dart", , O, {
  ...
  Device: {
    ...
    static: {Device__enableDevice: function() {
        ...
        t1 = document;
        C.HtmlDocument_methods._addEventListener$3(t1, "deviceready", new O.Device__enableDevice_doWhenDeviceReady(cmpl), null);
        return cmpl.future;
      }}
  },
...
["route.client", "package:route_hierarchical/client.dart", , D, {
  ...
  Router: {
    ...
    }, "route$1", "call$3$forceReload$startingFrom", "call$1", "get$route", 2, 5, 65, 18, 66, 67, 68, 69],
    ...
    listen$2$appRoot$ignoreClick: function(appRoot, ignoreClick) {
      ...
      if (this._useFragment) {
        ...
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(new D.Router_listen_closure(this)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
        t3 = t2.location.hash;
    ...
    }, "call$1", "get$_normalizeHash", 2, 0, 11, 70],
  ...
  Router__preLeave_closure0: {
    "^": "Closure:72;box_0,this_2,path_3,treePath_4,activePath_5,baseRoute_6,forceReload_7",
  ...
  Router__preEnter_closure0: {
    "^": "Closure:72;box_0,this_2,leaveFn_3",
    call$1: [function(results) {
      var t1;
  ...
  Router__filterQueryParams_closure: {
    "^": "Closure:37;queryParameters_0,watchQueryParameters_1,result_2",
    call$1: function(key) {
...
["url_template", "package:route_hierarchical/url_template.dart", , S, {
  ...
  UrlTemplate: {
    ...
    compareTo$1: function(_, other) {
      var thisPattern, otherPattern, thisPatternParts, t1, otherPatternParts, t2, t3, i, thisPart, otherPart;
      if (!!J.getInterceptor(other).$isUrlTemplate) {
        ...
        t2 = thisPatternParts.length;
        t3 = otherPatternParts.length;
        if (t2 === t3) {
          for (i = 0; i < thisPatternParts.length; ++i) {
            ...
            t2 = J.getInterceptor(thisPart);
            if (t2.$eq(thisPart, "\t") && !J.$eq(otherPart, "\t"))
              return 1;
            else if (!t2.$eq(thisPart, "\t") && J.$eq(otherPart, "\t"))
              return -1;
          }
...
Isolate.$lazy($, "router", "router", "get$router", function() {
  ...
  t3 = window;
  t1 = new D.Router(t2, t3, D.RouteImpl$_new(false, null, null, null, null), t1, true, false, null);
  t1.Router$_init$6$clickHandler$linkMatcher$sortRoutes$useFragment$windowImpl(null, null, null, true, null, null);
  return t1;
});
